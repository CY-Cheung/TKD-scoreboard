...
/**
 * Shared centre-referee confirm overlay for IVR / Technical Card.
 * @param {string} title - Suffix after "Blue:" / "Red:" (e.g. "IVR", "Technical Card")
 * @param {string} [rejectLabel="Reject"] - Reject button label
 */
